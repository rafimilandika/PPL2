					...
					<div class="card-body">
						<div class="card-body p-0">
							<table class="table">
								...
								<tr>
									<th>Penjelasan</th>
									<td><?php echo e($penjelasan); ?></td>
								</tr>
								<tr>
									<th>Penanganan</th>
									<td><?php echo e($penanganan); ?></td>
								</tr>
							</table>
...
<?php echo $__env->make('layouts.nonav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\corndoctor\resources\views/v_detail_penyakit.blade.php ENDPATH**/ ?>