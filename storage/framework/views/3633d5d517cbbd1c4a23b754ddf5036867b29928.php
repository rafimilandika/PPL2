...
<head>
    ...
    <title><?php echo e(config('CornDoctor')); ?></title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                        <!-- <li class="nav-item"><a href="#"></a>Diagnosa</li> -->
...
<?php /**PATH D:\XAMPP 7.3\htdocs\corndoctor\resources\views/layouts/app.blade.php ENDPATH**/ ?>